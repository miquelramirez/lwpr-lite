...
static PyTypeObject PyLWPR_Type = {
    ...
    .tp_name = "lwpr.LWPR",
    .tp_basicsize = sizeof(PyLWPR),
    .tp_dealloc = (destructor) PyLWPR_dealloc,
    .tp_repr = (reprfunc) PyLWPR_repr,
    ...
    "   model = LWPR('file.xml')\n",
    .tp_methods = PyLWPR_methods,
    .tp_getset = PyLWPR_getseters,
    .tp_new = PyLWPR_new
};

static PyMethodDef lwpr_methods[] = {{NULL}};

static PyModuleDef lwpr_module = {
    PyModuleDef_HEAD_INIT,
    .m_name = "lwpr",
    .m_doc =  "Python wrapper for the C implementation of LWPR."
};
